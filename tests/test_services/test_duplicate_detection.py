...
class TestDuplicateDetectionWithUrls:
    ...
    @pytest.mark.asyncio
    @pytest.mark.skipif(
        not DUPLICATE_URL_1 or not DUPLICATE_URL_2, reason="No test URLs configured"
    )
